...
from flask_template.server.services.event_manager import (
    get_all_list_event,
    get_active_paramedic_list_event,
    get_active_police_list_event,
    get_active_fire_service_event,
    get_event_by_id,
)
...
def show_police_active_events():
    ...
    return render_template(
        "police-show-all.html", police_events=police_active_events_list
    )
...
def show_fire_service_active_events():
    ...
    return render_template(
        "fire-show-all.html", fire_service_events=fire_service_active_events_list
    )
...
def page_not_found(_):
    ...
    return make_response(
        render_template("404.html", title="404", content="Page not found"), 404
    )
